...
This package contains publicly accessible data from our paper on the gene expression landscape of the human locus coeruleus (LC).
...
The package can be installed from [Bioconductor](https://bioconductor.org/packages/WeberDivechaLCdata) as follows:
